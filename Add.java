...
class Add extends JFrame implements ActionListener,KeyListener,FocusListener,ItemListener
{
	int i=0,j=0;
	...
	Add()
	{
        ...
        rb1.setBounds(370,255,70,20);
		rb2=new JRadioButton("Female");
        rb2.setBounds(450,255,70,20);
		rb3=new JRadioButton("default");
		rb3.setBounds(570,255,70,20);
		
		ButtonGroup bg=new ButtonGroup();
		
		ch1=new JCheckBox("UG");
		ch1.setBounds(170,295,100,20);
		ch2=new JCheckBox("PG");
		ch2.setBounds(295,295,100,20);
		ch3=new JCheckBox("Phd");
		ch3.setBounds(420,295,100,20);
		
		String country[]={"---Select Country---","india","USA","America"};
		cmbo1=new JComboBox(country);
		cmbo1.setBounds(370,380,150,30);
		
		cmbo2=new JComboBox();
		cmbo2.setBounds(370,425,150,30);
		...
		cmbo3.setBounds(165,520,300,30);
		
		t6=new JTextField();
		t6.setBounds(485,520,90,30);
		
	    ltb5=new JLabel();
	    ltb5.setBounds(370,472,150,30);
	...
	public void reset()
	{
     ...
     public void fillValue()
	 {
		 ...
		 {	
			...
			ps.setString(11,(String)cmbo3.getSelectedItem());
			ps.setString(12,t6.getText());
