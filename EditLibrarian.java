...
class EditLibrarian extends JFrame implements ActionListener,KeyListener,FocusListener,ItemListener
{
	int i=0,j=0;
	JLabel l1,unl,l2,l3,l4,l5,l6,l7,l8,l9,l0;
    JLabel euname,el1,el2,el3,el4,el5,el6,el0,ltb1,ltb2,ltb3,ltb4,ltb5;
	JTextField t0,t1,t2,t5,t6;
	JPasswordField p1,p2;
	JButton b1,b2,bt1,bt2,bt3,bt4,bt5;
    JRadioButton rb1,rb2,rb3;
	JCheckBox ch1,ch2,ch3;
	JComboBox cmbo1,cmbo2,cmbo3;
	DefaultComboBoxModel dc0,dc1,dc2,dc3;
	int id;
	String s1;
	
	EditLibrarian(int id,String s1,String s2,String s3,String s4,String s5,String s6,String s7,String s8,Long s9,String s10,String s11)
	{
		this.s1=s1;
		this.id=id;
		...
		l1=new JLabel("<html><u>Edit Librarian</u></html>");
		...
		p1=new JPasswordField(s3);//password
		...
		p2=new JPasswordField(s3);//confirm password
		...
		t2=new JTextField(s4);//Email field
		...
		else if(s6.equals("PG"))
			ch2.setSelected(true);
		else if(s6.equals("Phd"))
		...
		if(s7.equals("india"))
		{
		   cmbo1.setSelectedIndex(1);
		   cmbo2.setModel(dc1);

		   if(s8.equals("meerut"))
			   	cmbo2.setSelectedIndex(1);
		   if(s8.equals("delhi"))
			   cmbo2.setSelectedIndex(2);
		   if(s8.equals("noida"))
	   		   cmbo2.setSelectedIndex(3);
		}
	    else if(s7.equals("USA"))
		{
			cmbo1.setSelectedIndex(2);
			cmbo2.setModel(dc2);
			
			if(s8.equals("london"))
			   	cmbo2.setSelectedIndex(1);
		}
	    else if(s7.equals("America"))
		{
			cmbo1.setSelectedIndex(3);
		    cmbo2.setModel(dc3);
		...
		t5=new JTextField(String.valueOf(s9));//contact no.
		t5.setBounds(30,5,110,20);
	    t5.setBorder(BorderFactory.createMatteBorder(0,0,0,0,Color.gray));
 
        t6=new JTextField(String.valueOf(s11));//s_ans
		t6.setBounds(470,550,90,30);
	
		String sque[]={"---select your Security Question---","what is your pet name?","what was the name of your first school?","what is your favorite past-time?","what is your all time favorite sports team?","what is your father's middle name?"};	
		cmbo3=new JComboBox(sque);
		cmbo3.setBounds(160,550,300,30);
	...
	public void keyPressed(KeyEvent e)
	{
       if(e.getKeyCode()==KeyEvent.VK_ENTER)
       {
		    ...
		    if(fa==1)//no field empty
			{
			 ...
			 {
                updateValue(); //method for inserting values in the database table
	...
	*/
	...
	public int fieldsEmptyConstraint()
	{
		...
		if( t1.getText().isEmpty() || t2.getText().isEmpty() || t5.getText().isEmpty() || p1.getText().isEmpty() || p2.getText().isEmpty() || !(rb1.isSelected() || rb2.isSelected()) || !(ch1.isSelected() || ch2.isSelected() || ch3.isSelected() ) ||cmbo1.getSelectedIndex()==0 ||cmbo2.getSelectedIndex()==0||cmbo3.getSelectedIndex()==0 ||t6.getText().isEmpty()) 
			fa=0;
	...
	public void reset()
	{
     ...
     public void updateValue()
	 {
		 ...
		 {	
		    ...
		    PreparedStatement ps=con.prepareStatement("update librarian set username=?,name=?,password=?,email=?,gender=?,qualification=?,country=?,city=?,contact_no=?,s_que=?,s_ans=? where id=?");
			...
			ps.setString(7,(String)cmbo1.getSelectedItem());
			ps.setString(8,(String)cmbo2.getSelectedItem());
			ps.setLong(9,Long.parseLong(t5.getText()));
					
			ps.setString(10,(String)cmbo3.getSelectedItem());
